...
module spout(){
    cylinder(h = funnel_h, r1 = hole_r+wall_thickness, r2 = funnel_r);
}
module spout_bore(){
    cylinder(h = funnel_h, r1 = hole_r, r2 = funnel_r-wall_thickness);
}
...
translate([0,0,funnel_h])
cylinder(h=tray_h,r=funnel_r-wall_thickness);
}
